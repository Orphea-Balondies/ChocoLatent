...
def main(opts: ScriptOptions):
    ...
    model: nn.Module = timm.create_model("hf-hub:SmilingWolf/wd-vit-tagger-v3", checkpoint_path = "/root/chocolatent/model/wd-vit-tagger-v3/model.safetensors").eval()
    #state_dict = timm.models.load_state_dict_from_path("/root/chocolatent/model/wd-vit-tagger-v3")
