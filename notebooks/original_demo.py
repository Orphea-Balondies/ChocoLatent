...
process_item=[0]
version = "compareBlacknt"
eps=0.02
#image_adv_path = "../demo/images/mountains-in-distance_adv-photoguard-0.03.jpg"
'''
...
for i in process_item:
    ...
    image_nat, image_adv, adv_image = adv(image_adv_path,init_image, image_dict["prompt"], image_dict["strength"], image_dict["guidance_scale"], image_dict["SEED"])
